...
md"The following code can be used to find possible pivot patterns of Hadamard matrices of order 20. It should be noted that, in order to avoid rounding errors, the use of rational numbers was chosen for any operation whose result is significant and not necessarilly an integer."

# ╔═╡ 5b43bbd0-e447-11ed-380c-bff361b3361a
md"The following package is required:"

# ╔═╡ ac8b9277-0843-4d2b-b17b-72aa0ae6098e
import LinearAlgebra

# ╔═╡ 870ea327-7a76-4fc8-8c92-a4df03ef9388
md"Now we need the following functions:"
